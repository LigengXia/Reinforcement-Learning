...
class MDP:
    ...
    def step(self, action):
        ...
        state_prob_dict = self.get_next_states(self._current_state, action)
        possible_states, probs = zip(* state_prob_dict.items())
#         possible_states, probs = zip(*self.get_next_states(self._current_state, action).items())
        next_state_index = np.random.choice(len(possible_states), p=probs)
